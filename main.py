...
def system(query):
    ano = "your are not harshita sorry  i will not access system for you  "
    psw = "1234"
    ...
    if verify.lower() == psw:
        ...
        req = "hello harshita  opening system  "
        speaker.Speak(req)
...
while 1:
    ...
    if "the time" in query:
        ...
        myself = "my name is phoenix . I am an A I created by Harshita Tiwary on 4th june 2023. now tell me how may i help you."
